...
export class StrengthBar implements OnChanges {

    @Input() passwordToCheck: string;
    @Input() barLabel: string;
    @Output() strengthChanged:EventEmitter<any> = new EventEmitter();
    ...
    ngOnChanges(changes: {[propName: string]: SimpleChange}): void {
        ...
        let strength = StrengthBar.measureStrength(password);
